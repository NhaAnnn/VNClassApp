...
class UserSetPointsScreenWeb extends StatefulWidget {
  const UserSetPointsScreenWeb({super.key});
  static const String routeName = '/user_set_points_screen_web';

  @override
  State<UserSetPointsScreenWeb> createState() => _UserSetPointsScreenWebState();
}

class _UserSetPointsScreenWebState extends State<UserSetPointsScreenWeb> {
  ...
  void _showConditionsDialogTerm3(BuildContext context) {
    showDialog(
      context: context,
      builder: (BuildContext context) => const SetConditionsDialogTerm3(),
    );
  }
